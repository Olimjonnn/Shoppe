# Generated by Django 4.0.4 on 2022-07-05 11:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(1, 'Manager'), (2, 'User')], default=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_options', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='main.delivery_options')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.product')),
            ],
        ),
        migrations.CreateModel(
